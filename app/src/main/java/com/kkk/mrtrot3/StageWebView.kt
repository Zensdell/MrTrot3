...
class StageWebView : AppCompatActivity() {
    ...
    private lateinit var stageWebView: WebView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        stageWebView = findViewById<WebView>(R.id.stage_webview)
    ...
    override fun onBackPressed() {
        // 웹뷰에서 뒤로 갈 수 있는지 확인
        if (stageWebView.canGoBack()) {
            stageWebView.goBack() // 웹뷰의 뒤로 가기 기능 호출
        } else {
