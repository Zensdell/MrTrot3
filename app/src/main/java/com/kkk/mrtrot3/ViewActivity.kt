...
class ViewActivity : AppCompatActivity() {
    ...
    private lateinit var intentPhotoUrl: String
...
//                                      clearList!!,
        ...
        intentPhotoUrl = intent.getStringExtra("photoUrl").toString()
        ...
        setButtonClickListener(intentImageUrl!!, intentStageUrl!!, intentInfoUrl!!, intentCommentCount!!, intentPhotoUrl!!)
...
//        MediationTestSuite.launch(this,"ca-app-pub-8246055051187544~8203511508" )
                ...
                if(!isRuleAgree) {
                    android.app.AlertDialog.Builder(this)
                        ...
                        .setNeutralButton("이용약관 보기") {dialog, which ->
                            val uri = Uri.parse("https://sites.google.com/view/mrtrot3use")
    ...
    private fun setButtonClickListener(img: String,  stageUrl: String, infoUrl:String, commentCount: Long, photoUrl:String) {
...
//        bigImage.setImageResource(img)
        ...
        photoButton.setOnClickListener {
            if(photoUrl == "") {
                Toast.makeText(this, "새로운 사진을 업데이트 중입니다.", Toast.LENGTH_SHORT).show()
            } else {
        ...
        shareButton.setOnClickListener { try {
            val sendText = "감동의 무대를 선사한 미스터트롯3 함께 응원해요! 다운로드 - https://play.google.com/store/apps/details?id=com.kkk.mrtrot3"
